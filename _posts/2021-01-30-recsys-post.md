...
### 협업 필터링(Collaborative Filtering)
 ...
 콘텐츠 기반 필터링은 사용자나 아이템 자체의 정보를 분석해 사용자가 좋아한 아이템과 유사한 아이템을 찾아내는 방법입니다. 아이템에 따라서 텍스트, 이미지, 영상 등 다양한 데이터를 사용할 수 있고, 딥러닝 방법을 사용해 각 데이터에서 중요한 특성(feature)를 뽑아내는 방법이 많이 연구되고 있습니다. 대표적으로 자연어 처리 도메인에서 나온 Word2Vec등의 알고리즘을 사용하여 텍스트로부터 아이템의 정보를 얻을 수 있습니다.
